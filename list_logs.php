...
<html lang="en">
   ...
   <body>
    ...
    <div class="container p-3">
      ...
      <!-- <h6 class="pt-3">RFID Based Contact Tracing</h6> -->
      <div class="heading pt-4">
        <span class="h-1">User</span>
        <span class="h-2">Logs</span>
          ...
          <div class="form-row float-lg-right">
            ...
            <div class="form-group">
              <select class="form-control" name="filter" id="ControlSelect">
                ...
                <option value="est_name">Establishment</option>
              </select>
            </div>
            <div class="pl-2 pb-2">
             <input type="submit" class="btn btn-primary mb-2" name="submitL" value="Search">
            </div>
          </div>
        </form>
      </div>
    ...
    <!-- <footer>
        <h6 class="pt-3 text-center">RFID Based Contact Tracing</h6>
    </footer> -->
   </body>
